...
var HitDragListener = /** @class */ (function (_super) {
    ...
    HitDragListener.prototype.handleDragStart = function (ev) {
        ...
        // reports the initial hit the mouse is over
...
var TaskQueue = /** @class */ (function () {
    ...
    TaskQueue.prototype.runTask = function (task) {
        return task(); // tasks *is* the function, but subclasses can change the format of a tasks
    };
    return TaskQueue;
}());
...
var RenderQueue = /** @class */ (function (_super) {
    ...
    RenderQueue.prototype.canRunNext = function () {
        ...
        if (this.waitNamespace) {
            var q = this.q;
            // if there was a different namespace tasks in the meantime,
        ...
        var dragListener = new HitDragListener_1.default(component, {
            ...
            interactionEnd: function (ev, isCancelled) {
                if (!isCancelled && selectionFootprint) {
                    // the selection will already have been rendered. just reports it
